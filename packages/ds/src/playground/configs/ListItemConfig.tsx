...
export const ListItemConfig: ComponentConfig = {
  ...
  controls: {
    ...
    leftIcon:    { type: 'icon-picker', label: 'Left icon',   default: 'heartOutlined', showWhen: { field: 'leftSide', values: ['icon'] } },
    ...
    rightIcon:   { type: 'icon-picker', label: 'Right icon',  default: 'chevronArrowRight', showWhen: { field: 'rightAsset', values: ['icon', 'text-icon'] } },
